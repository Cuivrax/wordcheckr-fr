 ...
 */
// D-051/D-052 revalidation (2026-09-02, agent seo-registry) : recalcule sur les 844 961 termes
// (etait 838 180) apres l'ajout du complement kaikki. '2:a:z' et '2:u:w' liberees -- n'etaient
// des doublons du palier 1 (single-letter) QUE sur l'ancienne base (ex. Z seul = 1 mot avant,
// 3 aujourd'hui -- ZA n'egale plus le contenu de Z seul). Controle SOEURS (empreinte de contenu,
// jamais fait historiquement pour ce palier) ajoute a cette occasion : 0 groupe trouve sur les
// 26 lettres, toutes longueurs -- negatif confirme, pas suppose.
const AVEC_TWO_LETTERS_EXCLUDED_TIER_DUPLICATES = [
    '14:q:u' => true, '15:q:u' => true,
];
...
// D-051/D-052 revalidation (2026-09-02, agent seo-registry) : recalcule sur les 844 961
// termes (etait 838 180) apres l'ajout du complement kaikki, a DEUX methodes independantes :
// PARENT (egalite de cardinalite vs single-letter ET vs pair, exacte) et SOEURS (empreinte
// de contenu sha1 sur mots tries, meme longueur, 244 groupes trouves, 359 lignes perdantes --
// le triplet alphabetiquement le plus petit du groupe reste gagnant, meme convention que
// D-029/D-030/D-031). Union des deux methodes vs ancienne liste (660 entrees) : 577
// confirmees, 83 liberees (n'etaient doublon que sur l'ancienne base), 48 nouvelles
// (doublon reel confirme aujourd'hui, jamais exclu avant) -- total 625. Verifie : les 48
// nouvelles ET les 83 liberees sont absentes du registre actuel (0 regression sur une page
// deja en ligne, correction preventive sur un lot pas encore applique).
    '3:a:c:k' => true, '3:a:d:q' => true, '3:a:d:w' => true, '3:a:f:y' => true, '3:a:j:m' => true,
    '3:a:j:n' => true, '3:a:j:z' => true, '3:a:p:w' => true, '3:a:p:x' => true, '3:a:t:w' => true,
    '3:a:y:z' => true, '3:b:g:k' => true, '3:b:h:v' => true, '3:b:m:w' => true, '3:c:m:q' => true,
    '3:c:u:y' => true, '3:e:g:x' => true, '3:e:k:z' => true, '3:e:m:z' => true, '3:e:n:z' => true,
    '3:e:v:x' => true, '3:f:i:v' => true, '3:g:o:q' => true, '3:g:o:w' => true, '3:h:i:y' => true,
    '3:h:o:w' => true, '3:h:q:s' => true, '3:l:o:w' => true, '4:a:d:w' => true, '4:a:g:x' => true,
    '4:a:j:w' => true, '4:a:m:q' => true, '4:a:q:r' => true, '4:a:q:w' => true, '4:a:v:z' => true,
    '4:a:w:y' => true, '4:b:i:w' => true, '4:b:j:u' => true, '4:b:s:w' => true, '4:c:n:q' => true,
    '4:c:r:z' => true, '4:c:t:y' => true, '4:c:u:z' => true, '4:d:k:u' => true, '4:d:m:t' => true,
    '4:d:s:z' => true, '4:e:j:x' => true, '4:e:p:w' => true, '4:e:x:z' => true, '4:f:i:q' => true,
    '4:f:j:u' => true, '4:f:m:t' => true, '4:f:o:w' => true, '4:f:p:q' => true, '4:f:q:w' => true,
    '4:f:q:z' => true, '4:f:s:v' => true, '4:f:u:z' => true, '4:g:i:q' => true, '4:g:i:w' => true,
    '4:g:l:t' => true, '4:g:m:p' => true, '4:g:n:q' => true, '4:g:u:x' => true, '4:h:i:q' => true,
    '4:h:k:y' => true, '4:h:l:z' => true, '4:h:p:q' => true, '4:h:t:y' => true, '4:i:j:v' => true,
    '4:i:j:w' => true, '4:i:n:q' => true, '4:i:q:r' => true, '4:i:u:z' => true, '4:i:w:z' => true,
    '4:j:k:u' => true, '4:j:p:r' => true, '4:j:u:x' => true, '4:k:r:z' => true, '4:k:s:z' => true,
    '4:k:u:z' => true, '4:k:v:y' => true, '4:l:o:q' => true, '4:l:u:z' => true, '4:l:x:y' => true,
    '4:m:q:u' => true, '4:m:r:w' => true, '4:m:t:y' => true, '4:m:u:w' => true, '4:o:p:q' => true,
    '4:o:q:s' => true, '4:o:q:y' => true, '4:p:r:w' => true, '4:q:u:y' => true, '4:q:u:z' => true,
    '4:r:t:w' => true, '4:r:u:w' => true, '4:t:w:z' => true, '5:a:j:q' => true, '5:a:j:x' => true,
    '5:a:q:w' => true, '5:a:w:x' => true, '5:b:o:q' => true, '5:b:s:w' => true, '5:c:m:q' => true,
    '5:d:q:u' => true, '5:d:u:w' => true, '5:e:m:w' => true, '5:e:q:x' => true, '5:e:x:z' => true,
    '5:f:j:r' => true, '5:f:n:p' => true, '5:f:o:w' => true, '5:g:i:q' => true, '5:g:n:q' => true,
    '5:g:q:s' => true, '5:g:w:z' => true, '5:h:i:q' => true, '5:h:m:q' => true, '5:h:q:s' => true,
    '5:h:v:y' => true, '5:i:k:q' => true, '5:i:k:x' => true, '5:i:w:x' => true, '5:i:w:y' => true,
    '5:j:q:u' => true, '5:j:s:y' => true, '5:j:t:v' => true, '5:j:u:x' => true, '5:k:l:x' => true,
    '5:k:o:v' => true, '5:k:q:r' => true, '5:k:q:u' => true, '5:k:x:y' => true, '5:m:u:w' => true,
    '5:m:w:x' => true, '5:m:w:y' => true, '5:m:x:y' => true, '5:n:o:q' => true, '5:n:q:s' => true,
    '5:o:w:y' => true, '5:p:q:u' => true, '5:q:r:s' => true, '5:q:s:w' => true, '5:q:u:v' => true,
    '5:q:u:x' => true, '5:r:u:w' => true, '5:r:w:z' => true, '5:s:w:z' => true, '5:u:x:z' => true,
    '6:a:j:w' => true, '6:a:k:x' => true, '6:a:v:w' => true, '6:b:j:w' => true, '6:c:q:v' => true,
    '6:c:w:x' => true, '6:c:w:y' => true, '6:d:q:v' => true, '6:e:q:x' => true, '6:f:m:y' => true,
    '6:f:n:w' => true, '6:g:q:u' => true, '6:g:q:y' => true, '6:i:j:w' => true, '6:i:j:y' => true,
    '6:i:k:q' => true, '6:i:v:w' => true, '6:j:o:w' => true, '6:j:q:r' => true, '6:k:l:x' => true,
    '6:k:m:p' => true, '6:k:n:x' => true, '6:k:o:x' => true, '6:k:q:u' => true, '6:k:u:w' => true,
    '6:k:w:y' => true, '6:n:v:w' => true, '6:o:w:x' => true, '6:o:w:y' => true, '6:p:u:w' => true,
    '6:p:w:x' => true, '6:q:s:x' => true, '6:q:t:w' => true, '6:q:u:w' => true, '6:q:u:x' => true,
    '6:r:v:w' => true, '6:r:w:y' => true, '6:t:w:y' => true, '6:x:y:z' => true, '7:a:j:w' => true,
    '7:a:w:x' => true, '7:b:j:w' => true, '7:b:k:w' => true, '7:c:v:w' => true, '7:e:q:x' => true,
    '7:e:v:w' => true, '7:f:n:w' => true, '7:f:q:u' => true, '7:i:j:w' => true, '7:i:v:w' => true,
    '7:j:k:x' => true, '7:j:o:w' => true, '7:j:q:u' => true, '7:k:q:t' => true, '7:k:q:u' => true,
    '7:l:w:x' => true, '7:m:w:x' => true, '7:n:v:w' => true, '7:o:w:z' => true, '7:q:u:w' => true,
    '7:q:u:x' => true, '7:q:v:w' => true, '7:q:w:y' => true, '7:r:v:w' => true, '7:t:w:x' => true,
    '7:w:x:y' => true, '8:a:j:w' => true, '8:a:w:x' => true, '8:b:q:u' => true, '8:e:v:w' => true,
    '8:e:x:z' => true, '8:f:h:w' => true, '8:f:q:u' => true, '8:g:q:u' => true, '8:h:j:y' => true,
    '8:i:j:w' => true, '8:i:k:q' => true, '8:j:k:w' => true, '8:j:m:w' => true, '8:j:n:w' => true,
    '8:j:o:w' => true, '8:j:q:u' => true, '8:j:w:y' => true, '8:k:l:q' => true, '8:k:q:u' => true,
    '8:k:x:y' => true, '8:l:v:w' => true, '8:m:v:w' => true, '8:m:w:x' => true, '8:n:v:w' => true,
    '8:o:v:w' => true, '8:q:r:w' => true, '8:q:u:v' => true, '8:q:u:x' => true, '8:q:u:y' => true,
    '8:r:v:w' => true, '8:s:v:w' => true, '8:s:w:x' => true, '8:v:w:z' => true, '8:w:x:y' => true,
    '9:a:j:w' => true, '9:a:k:x' => true, '9:a:w:x' => true, '9:f:h:w' => true, '9:f:q:u' => true,
    '9:h:w:x' => true, '9:i:q:w' => true, '9:j:n:w' => true, '9:j:q:u' => true, '9:j:t:w' => true,
    '9:j:w:z' => true, '9:k:q:u' => true, '9:n:q:w' => true, '9:n:w:x' => true, '9:o:w:x' => true,
    '9:p:q:u' => true, '9:q:r:w' => true, '9:q:u:v' => true, '9:q:u:w' => true, '9:q:u:x' => true,
    '9:q:u:y' => true, '9:r:w:x' => true, '9:s:w:x' => true, '9:t:w:x' => true, '10:a:j:w' => true,
    '10:b:j:w' => true, '10:d:q:u' => true, '10:e:j:w' => true, '10:e:v:w' => true, '10:e:w:x' => true,
    '10:e:x:z' => true, '10:f:q:u' => true, '10:g:j:y' => true, '10:g:q:u' => true, '10:g:v:w' => true,
    '10:g:w:y' => true, '10:i:w:x' => true, '10:j:l:w' => true, '10:j:l:y' => true, '10:j:n:w' => true,
    '10:j:o:w' => true, '10:j:q:u' => true, '10:j:r:w' => true, '10:j:u:w' => true, '10:k:q:u' => true,
    '10:k:v:w' => true, '10:l:q:u' => true, '10:l:w:x' => true, '10:n:w:x' => true, '10:o:w:x' => true,
    '10:p:q:u' => true, '10:q:s:w' => true, '10:q:u:v' => true, '10:q:u:w' => true, '10:q:u:x' => true,
    '10:q:u:y' => true, '10:r:w:x' => true, '10:s:w:x' => true, '10:t:w:x' => true, '10:u:w:x' => true,
    '11:c:q:w' => true, '11:d:q:u' => true, '11:e:q:w' => true, '11:e:v:w' => true, '11:e:w:x' => true,
    '11:f:h:w' => true, '11:f:k:p' => true, '11:f:q:u' => true, '11:g:j:y' => true, '11:g:q:u' => true,
    '11:h:q:u' => true, '11:h:w:x' => true, '11:i:q:w' => true, '11:i:v:w' => true, '11:i:w:x' => true,
    '11:j:m:x' => true, '11:j:q:u' => true, '11:j:x:y' => true, '11:k:q:u' => true, '11:l:q:u' => true,
    '11:l:w:x' => true, '11:m:w:x' => true, '11:n:q:w' => true, '11:o:q:w' => true, '11:o:w:x' => true,
    '11:q:r:w' => true, '11:q:s:w' => true, '11:q:u:v' => true, '11:q:u:w' => true, '11:q:u:x' => true,
    '11:q:u:y' => true, '11:q:v:w' => true, '11:s:w:x' => true, '12:c:k:x' => true, '12:d:k:x' => true,
    '12:d:q:u' => true, '12:e:j:k' => true, '12:e:k:x' => true, '12:e:q:w' => true, '12:e:w:x' => true,
    '12:e:x:z' => true, '12:f:j:x' => true, '12:f:q:u' => true, '12:g:q:u' => true, '12:h:q:u' => true,
    ...
    '12:k:u:x' => true, '12:k:v:x' => true, '12:l:q:u' => true, '12:l:w:x' => true, '12:m:w:x' => true,
    '12:o:w:x' => true, '12:p:w:y' => true, '12:q:u:v' => true, '12:q:u:w' => true, '12:q:u:x' => true,
    '12:q:u:y' => true, '12:r:w:x' => true, '12:s:w:x' => true, '13:a:j:x' => true, '13:a:k:x' => true,
    '13:b:e:w' => true, '13:b:q:u' => true, '13:c:q:u' => true, '13:d:q:u' => true, '13:e:g:j' => true,
    '13:e:j:k' => true, '13:e:j:y' => true, '13:e:j:z' => true, '13:e:k:x' => true, '13:e:m:w' => true,
    '13:e:p:w' => true, '13:e:q:w' => true, '13:e:q:x' => true, '13:e:q:z' => true, '13:e:v:w' => true,
    '13:e:w:x' => true, '13:e:w:y' => true, '13:e:w:z' => true, '13:e:x:z' => true, '13:f:k:v' => true,
    '13:f:q:u' => true, '13:g:j:y' => true, '13:g:q:u' => true, '13:h:q:u' => true, '13:i:q:w' => true,
    '13:i:v:w' => true, '13:i:w:x' => true, '13:i:w:y' => true, '13:j:k:l' => true, '13:j:k:u' => true,
    '13:j:m:x' => true, '13:j:p:y' => true, '13:j:q:u' => true, '13:j:q:x' => true, '13:j:s:y' => true,
    '13:k:l:x' => true, '13:k:n:x' => true, '13:k:o:x' => true, '13:k:q:u' => true, '13:l:q:u' => true,
    '13:l:w:x' => true, '13:m:q:u' => true, '13:m:w:x' => true, '13:o:w:x' => true, '13:p:q:u' => true,
    '13:p:s:w' => true, '13:p:w:z' => true, '13:q:s:w' => true, '13:q:u:v' => true, '13:q:u:w' => true,
    '13:q:u:x' => true, '13:q:u:y' => true, '13:q:u:z' => true, '13:s:w:x' => true, '13:u:w:x' => true,
    '13:w:y:z' => true, '14:a:j:k' => true, '14:a:j:x' => true, '14:a:k:x' => true, '14:a:q:u' => true,
    '14:b:q:u' => true, '14:c:j:k' => true, '14:c:q:u' => true, '14:d:q:u' => true, '14:e:g:w' => true,
    '14:e:h:j' => true, '14:e:j:v' => true, '14:e:k:q' => true, '14:e:k:w' => true, '14:e:k:z' => true,
    '14:e:p:w' => true, '14:e:q:u' => true, '14:e:q:w' => true, '14:e:q:z' => true, '14:e:v:w' => true,
    '14:e:v:x' => true, '14:e:v:z' => true, '14:e:w:x' => true, '14:e:w:y' => true, '14:e:w:z' => true,
    '14:e:x:z' => true, '14:f:k:v' => true, '14:f:q:u' => true, '14:g:q:u' => true, '14:h:j:p' => true,
    '14:h:j:y' => true, '14:h:q:u' => true, '14:i:j:q' => true, '14:i:j:y' => true, '14:i:k:w' => true,
    '14:i:p:w' => true, '14:i:q:u' => true, '14:i:v:w' => true, '14:i:w:x' => true, '14:j:k:m' => true,
    '14:j:q:u' => true, '14:k:l:x' => true, '14:k:n:x' => true, '14:k:o:x' => true, '14:k:p:v' => true,
    '14:k:p:w' => true, '14:k:q:u' => true, '14:k:r:x' => true, '14:k:w:y' => true, '14:l:q:u' => true,
    '14:l:w:x' => true, '14:m:q:u' => true, '14:n:q:u' => true, '14:o:q:u' => true, '14:o:w:x' => true,
    '14:p:q:u' => true, '14:p:u:w' => true, '14:p:w:y' => true, '14:p:w:z' => true, '14:q:r:u' => true,
    '14:q:s:u' => true, '14:q:t:u' => true, '14:q:u:v' => true, '14:q:u:w' => true, '14:q:u:x' => true,
    '14:q:u:y' => true, '14:q:u:z' => true, '14:r:w:x' => true, '14:s:w:x' => true, '14:u:w:x' => true,
    '14:u:w:y' => true, '14:w:y:z' => true, '15:a:j:k' => true, '15:a:j:x' => true, '15:a:k:x' => true,
    '15:a:q:u' => true, '15:b:e:j' => true, '15:b:e:w' => true, '15:b:i:w' => true, '15:b:o:w' => true,
    '15:b:q:u' => true, '15:b:w:x' => true, '15:c:j:k' => true, '15:c:j:y' => true, '15:c:q:u' => true,
    '15:d:e:k' => true, '15:d:j:y' => true, '15:d:q:u' => true, '15:e:f:w' => true, '15:e:f:x' => true,
    '15:e:f:z' => true, '15:e:g:k' => true, '15:e:g:w' => true, '15:e:g:x' => true, '15:e:h:j' => true,
    '15:e:j:k' => true, '15:e:j:l' => true, '15:e:j:m' => true, '15:e:j:q' => true, '15:e:j:v' => true,
    '15:e:j:y' => true, '15:e:j:z' => true, '15:e:k:p' => true, '15:e:k:q' => true, '15:e:k:w' => true,
    '15:e:k:x' => true, '15:e:k:z' => true, '15:e:m:w' => true, '15:e:p:w' => true, '15:e:q:u' => true,
    '15:e:q:w' => true, '15:e:q:y' => true, '15:e:q:z' => true, '15:e:r:w' => true, '15:e:t:w' => true,
    '15:e:u:w' => true, '15:e:v:w' => true, '15:e:v:x' => true, '15:e:w:x' => true, '15:e:w:y' => true,
    '15:e:w:z' => true, '15:e:x:z' => true, '15:f:j:s' => true, '15:f:k:v' => true, '15:f:p:w' => true,
    '15:f:q:u' => true, '15:g:j:p' => true, '15:g:q:u' => true, '15:g:v:w' => true, '15:h:i:j' => true,
    '15:h:j:p' => true, '15:h:j:y' => true, '15:h:q:u' => true, '15:h:v:w' => true, '15:i:j:q' => true,
    '15:i:j:v' => true, '15:i:j:y' => true, '15:i:j:z' => true, '15:i:k:w' => true, '15:i:m:w' => true,
    '15:i:p:w' => true, '15:i:q:u' => true, '15:i:v:w' => true, '15:i:w:x' => true, '15:i:w:z' => true,
    '15:j:k:m' => true, '15:j:o:y' => true, '15:j:q:s' => true, '15:j:q:u' => true, '15:j:r:x' => true,
    '15:j:r:y' => true, '15:j:s:x' => true, '15:j:s:y' => true, '15:j:u:x' => true, '15:k:l:x' => true,
    '15:k:n:x' => true, '15:k:o:v' => true, '15:k:o:x' => true, '15:k:p:v' => true, '15:k:q:u' => true,
    '15:k:r:x' => true, '15:k:s:x' => true, '15:k:w:y' => true, '15:l:q:u' => true, '15:l:w:x' => true,
    '15:m:q:u' => true, '15:n:q:u' => true, '15:o:p:w' => true, '15:o:q:u' => true, '15:o:w:x' => true,
    '15:o:w:y' => true, '15:p:q:u' => true, '15:p:q:w' => true, '15:p:r:w' => true, '15:p:u:w' => true,
    '15:p:w:y' => true, '15:p:w:z' => true, '15:q:r:u' => true, '15:q:s:u' => true, '15:q:t:u' => true,
    '15:q:u:v' => true, '15:q:u:w' => true, '15:q:u:x' => true, '15:q:u:y' => true, '15:q:u:z' => true,
    '15:r:w:x' => true, '15:s:w:x' => true, '15:u:w:x' => true, '15:u:w:y' => true, '15:w:y:z' => true,
];

const D041_EXCLUDED_ROUTE_PATHS = [
    // D-051 (2026-09-02) : cette exclusion originale ('/mots/2-lettres/avec/w' == doublon de
    // '/mots/terminant/wu', 1 mot WU) est PERIMEE -- avec/w-2lettres est desormais WE/WI/WU/WW
    // (4 mots), plus identique a terminant/wu. Mais releve un nouveau candidat doublon NON
    // resolu : avec/w-2lettres == commencant/w-2lettres (meme 4 mots, /mots/2-lettres/commencant/w
    // deja present au registre en noindex,follow) -- gagnant canonique entre les deux pas encore
    // tranche ici (necessite le meme protocole DuplicatePageResolver que le reste de ce lot).
    // Laisse EXCLU par prudence en attendant cette resolution -- a traiter dans le chantier de
    // suivi (revalidation complete de D041_EXCLUDED_ROUTE_PATHS, ~1467 entrees).
